...
?>
<div class="<?php echo ( $content_div );?>">
	<?php
		/**
	...
	<div id="tg-content" class="tg-content">
		<div class="itemscope" id="product-<?php the_ID(); ?>" <?php post_class(); ?>>
			<div class="tg-products tg-productdetail">
				<div class="row">
					...
					<meta content="<?php esc_url( the_permalink() ); ?>" />
